...
<html>
<head>
<title>Gem Stone a Fashion Category Flat Bootstrap Responsive Website Template| Typography :: w3layouts</title>
			 ...
			 <div class="header">
				  ...
				  <div class="top-nav">										 
					   ...
					   <ul class="nav">
						 ...
						 <li class="dropdown1"><a href="jewellery.php">JEWELLERY</a>
							 <ul class="dropdown2">
									<li><a href="jewellery.php">PENDANTS</a></li>
									<li><a href="jewellery.php">BRACELETS</a></li>
									<li><a href="jewellery.php">EARRINGS</a></li>
									<li><a href="jewellery.php">PEARLS</a></li>
							  </ul>
						 </li> 
							  <li class="dropdown1"><a class="active" href="typography.php">GOLD COINS</a>
							  <ul class="dropdown2">
									<li><a href="typography.php">1 GRAM</a></li>
									<li><a href="typography.php">5 GRAMS</a></li>
									<li><a href="typography.php">10 GRAMS</a></li>												
							  </ul>
						  </li>
						 <li class="dropdown1"><a href="gallery.php">GALLERY</a>
							 <ul class="dropdown2">
		...
		<div class="footer-grids">
			...
			<div class="ftr-menu">
				 <ul>
					 ...
					 <li><a href="typography.php">GOLD COINS</a></li>
